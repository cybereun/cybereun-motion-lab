...
Cybereun Motion Lab은 오픈소스 Amicro 프로젝트를 기반으로 개인화하고 기능을 확장한 React 마이크로 인터랙션 컬렉션입니다. 짙은 남색 중심의 시각 체계 안에서 다양한 모션 컴포넌트를 검색하고, 레이아웃을 바꾸고, 직접 움직여 본 뒤 구현 코드를 복사할 수 있습니다.
...
- **세 가지 보기 방식** — 목록, 그리드, 매트릭스 레이아웃을 지원합니다.
- **분류 및 정렬** — Buttons, Card Spreads, 3D Carousels, Loaders 카테고리와 A–Z 정렬을 제공합니다.
